...
<input className=" w-[212px] rounded-[8px] ml-315 h-[37px] border border-zinc-300 outline-0 placeholder:text-zinc-300" type="Search" name="search" id="search" placeholder="Search..." />
